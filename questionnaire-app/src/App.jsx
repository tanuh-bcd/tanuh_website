...
function App() {
  ...
  // OPTIMIZATION: Memoize these objects to prevent unnecessary re-renders of the Questionnaire
  // and all QuestionBlock components when App state changes (e.g., isSubmitting).
  // They only need to update when the translation function 't' changes (i.e., language changes).
