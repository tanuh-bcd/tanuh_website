...
function App() {
  ...
  // Memoized to ensure referential stability for child components (Questionnaire)
  // eslint-disable-next-line react-hooks/exhaustive-deps
  const formStructure = React.useMemo(() => t('questionnaire:formStructure', { returnObjects: true }), [t, i18n.language]);
  // eslint-disable-next-line react-hooks/exhaustive-deps
  const questionnaireData = React.useMemo(() => t('questionnaire:questions', { returnObjects: true }), [t, i18n.language]);
